...
export default function Home({searchParams}: any) {
  ...
  useEffect(() => {
    getOrder(searchParams.order_hash).then(setDetailsInfo).then(()=>{
      ...
      <div className={`${styles.qrpay}`}>
        ...
        <div className={`${styles.container} ${styles.transport}`}>
          ...
          <p>
            ...
            {new Date(detailsInfo.data.ships.time_received || (detailsInfo.data.delivered_at + 7*24*60*60*1000)).toLocaleDateString('en-DE')}
          </p>
